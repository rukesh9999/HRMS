...
<center><h3>ALL EMPLOYEES DETAILS </h3></center>
</div>
...
<% 
List<EmployeeCompleteInfoVO>  EmployeeCompleteInfoVOs = (List<EmployeeCompleteInfoVO>)request.getAttribute("EmployeeCompleteInfoVOs");
...
%>
  ...
  <th>TypeofBand</th>
           ...
           <%for(int i=0;i<EmployeeCompleteInfoVOs.size();i++) {
        	   EmployeeCompleteInfoVO EmployeeCompleteInfoVO =   EmployeeCompleteInfoVOs.get(i);%>
       ...
       <td><% out.print(EmployeeCompleteInfoVO.getEmployeeperformance());%></td>
        <td><% out.print(EmployeeCompleteInfoVO.getTypeofband());%></td></tr>
  <% } %>
   
  </table></center></br></br>
  
          <center><a href="index.html" class="btn btn-primary">HOME</a>
          <a href="getAllEmployeesInfo.jsp" class="btn btn-primary">BACK</a></br></br></br></br></br></br></br></br></br></br></br></br></br></br>
          </center> 
