...
<center><h3>ALL EMPLOYEE SALARY DETAILS </h3></center>
</div>
...
<% 
List<EmployeePaySalaryVO>  EmployeePaySalaryVOs = (List<EmployeePaySalaryVO>)request.getAttribute("EmployeePaySalaryVO");
//out.print("<center>"+employeeLeaveDetailsVo.getEmpNo()+".."+employeeLeaveDetailsVo.getTypeOfLeave()+".."+employeeLeaveDetailsVo.getStartDate()+".."+employeeLeaveDetailsVo.getEndDate()+"..."+employeeLeaveDetailsVo.getNoOfLeaves()+"</center>") ;%>
  ...
  <tr>
   ...
   <th>Net_Pay</th>
       ...
       <%for(int i=0;i<EmployeePaySalaryVOs.size();i++) {
    	   EmployeePaySalaryVO EmployeePaySalaryVO =   EmployeePaySalaryVOs.get(i);%>
       ...
       <td><% out.print(EmployeePaySalaryVO.getNetpay());%></td></tr>
 <% } %>
   
  </table></center></br></br>
  
          <center><a href="index.html" class="btn btn-primary">HOME</a>
          <a href="getAllEmployeesSalaryInfo.jsp" class="btn btn-primary">BACK</a></br></br></br></br></br></br></br></br></br></br></br></br></br></br>
          </center> 
