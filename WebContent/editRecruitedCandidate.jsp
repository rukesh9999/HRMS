...
<center> <h2>EDIT  Recruited Candidate FORM</h2></center>
</div>
...
<c:forEach items="${AddRecruitedCandidateVOlist}" var="AddRecruitedCandidateVO" >
...
<center><table style="width:80%">
  <tr>
   <td> ID   </br></br></td>
   <td> <input type="text" name="id" value="${AddRecruitedCandidateVO.id}"   ></td>
  </tr>
  
  <tr>
   <td> FullName   </br></br></td>
   <td> <input type="text" name="fullname"  value="${AddRecruitedCandidateVO.fullName}"   ></td>
  </tr>
 
   
    <tr>
   <td>Year OF PassedOut</td>
   <td>   <input type="text"  name="yearofpassedout" value="${AddRecruitedCandidateVO.yearOFPassedOut}"  placeholder="YearOfPassedOut"></br></br></td>
  </tr>
  
  
   <tr>
   <td>Percentage</td>
   <td>   <input type="text"  name="percentage" value="${AddRecruitedCandidateVO.percentage}" placeholder="Percentage"></br></br></td>
  </tr>
