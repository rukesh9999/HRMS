...
<center><h3>ALL EMPLOYEE PERFORMANCE DETAILS </h3></center>
</div>
...
<% 
List<EmployeePerformanceAndReviewVO>  EmployeePerformanceAndReviewVOs = (List<EmployeePerformanceAndReviewVO>)request.getAttribute("EmployeePerformanceAndReviewVO");
%>
  ...
  <th>TypeofBand</th>
       ...
       <%for(int i=0;i<EmployeePerformanceAndReviewVOs.size();i++) {
    	   EmployeePerformanceAndReviewVO EmployeePerformanceAndReviewVO =   EmployeePerformanceAndReviewVOs.get(i);%>
